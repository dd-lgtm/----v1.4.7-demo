...
type InputBoxVariant = 'Add' | 'adding'
...
const InputBox: React.FC<InputBoxProps> = ({ variant = 'Add', onSubmit, onCancel, initialText = '', noBorder = false, noShadow = false }) => {
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: '16px',
        boxShadow: (isAdding && !noShadow) ? '1px 2px 4px 0px rgba(0,0,0,0.08), 0px 3px 8px 0px rgba(0,0,0,0.05)' : 'none',
